...
const code=pre+'\n'+roomsSrc+'\n'+pureSrc+
'\nmodule.exports={S,ROOMS,mergePrevText,prevTs,FLOOR,FEEDEC,floorFor,med,checkLines,buildWorkbook,feelWord,byTable,setHist:function(h){HIST=h;},setTanks:function(t){TANKS=t;},hoursSinceShot,dofNow,buildRoute,poreEC,permCounts,vwcCounts,parseText,frameBytes,crc16,rxBytes,PEGS,ACCESS,SKIPWHY,tableSkipped,skipReason,skippedList,sweepStamp,rowNoteLines,buildRowNotes,buildRoomNotes,roomHead,roomPara,strainFor,strainListFor,rowDateTime,reRoomRows,feedEcFor,tankFor,TANK_IDS};';
